...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder1">
    <form id="form1" runat="server">
        ...
        <br />
            <p style="height: 200px; color: #FFFFFF;">
         The game will cost $60.00, €57.01, ₤40.71, plus tax.
            ...
            <asp:TextBox ID="FName" runat="server" ForeColor="Blue">First name</asp:TextBox>
...
&nbsp;<asp:TextBox ID="City" runat="server" AutoCompleteType="FirstName" style="margin-top: 0px"></asp:TextBox>
                <br />
        </p>
        </div>
    </form>
